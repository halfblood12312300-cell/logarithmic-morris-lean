...
\end{center}
The repository root contains \texttt{lakefile.toml},
\texttt{lake-manifest.json}, and \texttt{lean-toolchain}.  The last of
these pins
\[
\texttt{leanprover/lean4:v4.28.0},
\]
and \texttt{lakefile.toml} pins Mathlib at \texttt{v4.28.0}.  On
...
final target, runs an independent \texttt{nanoda} check with
\texttt{sorryAx} disallowed, and prints the same axiom closure.
